      ...
      <div className="space-y-12 text-sm leading-7 text-sumi-soft">
        ...
        <section>
          ...
          <p className="mt-4">
            ...
            のトップから変えられます。直近の催しは、開催中があれば開催中を、なければ開催予定を出し、上段に会場、下段に個別の催しを出します。並びは毎回ランダムです。指定した順にも切り替えられます。催しの一覧は開催中・開催予定に分かれ、総合開催、会場、個別の催しの順で出ます。過去の催しはアーカイブです。冒頭の写真と文言、01 VILLAGE（複数可。複数あるときは約20秒ごとにスライドします）、「このサイトについて」のコンセプト、村を訪ねるの写真も同じ画面から直せます。
          </p>
        </section>
